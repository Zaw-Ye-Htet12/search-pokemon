...
// The Switch component with added transition animations
...
>(({ className, icon, thumbClassName, ...props }, ref) => (
   <SwitchPrimitives.Root
      className={cn(
         ...
         // Add a transition duration to the root for the color change
   ...
   >
      <SwitchPrimitives.Thumb
         className={cn(
            ...
            // Add a longer transition duration to the thumb for a smoother slide
...
const SwitchWithThemeAnimation = () => {
...
export default SwitchWithThemeAnimation;
